...
#	print('nlp_df  ---------- \n',nlp_df)
	...
	for articleNgram in articleNgrams:
		ngramId = articleNgram.NgramId_id
		articleId = articleNgram.ArticleId_id
		tfidf = articleNgram.TFIDF
#		print('articleId',articleId)
...
#		print('Data type of variable stdFrequency',type(int(stdFrequency)))
		nlp_df.set_value(articleId,ngramId,int(tfidf))
...
#	print('Shape of nlp_df_t after transpose',nlp_df_t.shape)
	...
	try:
		engine = create_engine("mysql+mysqldb://root:vik12345@localhost:3306/nlp2")
