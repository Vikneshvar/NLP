...
#		print("match count: ", len(matches))
		...
		tf=len(matches)/wordCount
		dict_articleNgram = {}
		dict_articleNgram["NgramId"] = ngramId
		dict_articleNgram["TF"] = tf
		dict_articleNgram["IDF"] = tf*idf
...
#	print('sourceName', sourceName)
	...
	for articleNgram in list_articleNgram:
		...
		idf = articleNgram.get('IDF')
#		print('ngramId',ngramId)
#		print('stdFrequency',stdFrequency)
		nlp_df.set_value(0,ngramId,idf)
...
#	nodes_3rd=int(len(nlp_df.columns)/1000)
	...
	# Variable to hold the actual outputx
	...
	with tf.Session() as sess:
		...
		print('y_predicted',y_prob.eval(feed_dict={x:x_M,W1:W1_predict,W2:W2_predict,B1:B1_predict,
									B2:B2_predict,keep_prob:1.0}))
